...
export const PaletteTree = () => (
    <Palette>
        <Category name="Layout">
            ...
            <Component name="MediaQuery" docURL="https://mantine.dev/core/media-query/">
                <Variant>
                    <MediaQuery
            ...
            <Component name="SimpleGrid" docURL="https://mantine.dev/core/simple-grid/">
                <Variant>
                    <SimpleGrid
                        cols={4}
                        spacing="lg"
        ...
        <Category name="Buttons">
            ...
            <Component name="CloseButton" docURL="https://mantine.dev/core/close-button/">
                <Variant>
                    <CloseButton />
                </Variant>
            </Component>
            <Component name="CopyButton" docURL="https://mantine.dev/core/copy-button/">
                <Variant>
                    <CopyButton value="https://mantine.dev">
                        {({ copied, copy }) => (
                            <Button color={copied ? 'teal' : 'blue'} onClick={copy}>
            ...
            <Component name="FileButton" docURL="https://mantine.dev/core/file-button/">
                <Variant proto={FileButtonProto} />
                <Variant name="multiple" proto={FileButtonMultipleProto} />
            </Component>
            <Component name="UnstyledButton" docURL="https://mantine.dev/core/unstyled-button/">
                <Variant>
        ...
        <Category name="Inputs">
            ...
            <Component name="ColorPicker" docURL="https://mantine.dev/core/color-picker/">
                <Variant>
                    <ColorPicker />
                </Variant>
                <Variant name="rgb">
            ...
            <Component name="MultiSelect" docURL="https://mantine.dev/core/multi-select/">
                <Variant>
                    <MultiSelect
                        label="Your label"
                        placeholder="Your placeholder"
            ...
            <Component name="NativeSelect" docURL="https://mantine.dev/core/native-select/">
                <Variant>
                    <NativeSelect
                        label="Your label"
                        description="Your description"
            ...
            <Component name="NumberInput" docURL="https://mantine.dev/core/number-input/">
                <Variant>
                    <NumberInput
                        label="Your label"
                        description="Your description"
            ...
            <Component name="PasswordInput" docURL="https://mantine.dev/core/password-input/">
                <Variant>
                    <PasswordInput
                        label="Your label"
                        description="Your description"
            ...
            <Component name="SegmentedControl" docURL="https://mantine.dev/core/segmented-control/">
                <Variant>
                    <SegmentedControl
                        data={[
        ...
        <Category name="Navigation">
            ...
            <Component name="Breadcrumbs" docURL="https://mantine.dev/core/breadcrumbs/">
                <Variant>
                    <Breadcrumbs>
                        <Anchor href="#">
                            link1
            ...
            <Component name="Pagination" docURL="https://mantine.dev/core/pagination/">
                <Variant>
                    <Pagination total={10} />
                </Variant>
                <Variant name="color">
        ...
        <Category name="Data Display">
            ...
            <Component name="Badge" docURL="https://mantine.dev/core/badge/">
                ...
                <Variant name="gradient">
                    <Badge variant="gradient" gradient={{ from: 'red', to: 'blue' }}>Badge</Badge>
                </Variant>
            </Component>
            ...
            <Component name="ColorSwatch" docURL="https://mantine.dev/core/color-swatch/">
                <Variant>
            ...
            <Component name="Timeline" docURL="https://mantine.dev/core/timeline/">
                <Variant>
                    <Timeline active={1} bulletSize={24} lineWidth={2}>
                        ...
                        <Timeline.Item title="Point3" bullet={<CheckIcon />} lineVariant="dashed">
                            Text
                        </Timeline.Item>
        ...
        <Category name="Overlays">
            ...
            <Component name="LoadingOverlay" docURL="https://mantine.dev/core/loading-overlay/">
                <Variant>
        ...
        <Category name="Typography">
            <Component name="Blockquote" docURL="https://mantine.dev/core/blockquote/">
                <Variant>
            ...
            <Component name="Mark" docURL="https://mantine.dev/core/mark/">
                <Variant>
                    <Text>Text <Mark>Marked text</Mark> Text</Text>
                </Variant>
                <Variant name="color">
                    <Text>Text <Mark color="red">Marked text</Mark> Text</Text>
                </Variant>
            </Component>
            ...
            <Component name="Text" docURL="https://mantine.dev/core/text/">
                ...
                <Variant name="link">
                    <Text variant="link" component="a" href="#">Link variant</Text>
                </Variant>
        ...
        <Category name="Feedback">
            ...
            <Component name="Notification" docURL="https://mantine.dev/core/notification/">
                <Variant>
            ...
            <Component name="Progress" docURL="https://mantine.dev/core/progress/">
                ...
                <Variant name="sections">
                    <Progress
                        sections={[
                            { value: 25, color: 'pink', label: 'Label1', tooltip: 'Tooltip1' },
            ...
            <Component name="RingProgress" docURL="https://mantine.dev/core/ring-progress/">
                <Variant>
                    <RingProgress
                        label="Your label"
                        sections={[
        ...
        <Category name="Miscellaneous">
            ...
            <Component name="ScrollArea" docURL="https://mantine.dev/core/scroll-area/">
                <Variant>
            ...
            <Component name="Transition" docURL="https://mantine.dev/core/transition/">
...
function FormExampleProto() {
    ...
    return (
        ...
        >
            ...
            <NumberInput
                label="Number"
                {...form.getInputProps('object.number')}
            />
...
function TransitionProto(transition: 'fade' | 'skew-up' | 'skew-down' | 'rotate-right' | 'rotate-left' | 'slide-down' | 'slide-up' | 'slide-right' | 'slide-left' | 'scale-y' | 'scale-x' | 'scale' | 'pop' | 'pop-top-left' | 'pop-top-right' | 'pop-bottom-left' | 'pop-bottom-right') {
    const [opened, setOpened] = useState(false);
...
function TransitionHoverDemoProto(transition: 'fade' | 'skew-up' | 'skew-down' | 'rotate-right' | 'rotate-left' | 'slide-down' | 'slide-up' | 'slide-right' | 'slide-left' | 'scale-y' | 'scale-x' | 'scale' | 'pop' | 'pop-top-left' | 'pop-top-right' | 'pop-bottom-left' | 'pop-bottom-right') {
    const [opened, setOpened] = useState(false);
    ...
    return (
        <>
            <Stepper active={active} onStepClick={setActive} breakpoint="sm">
                ...
                <Stepper.Step label="Second step" description="Your description" loading>
                    Step 2 content
                </Stepper.Step>
